...
const nav: { href: string; key: TKey; icon: string }[] = [
  { href: "/dashboard", key: "navOverview", icon: "M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z" },
  { href: "/dashboard/menu", key: "navMenu", icon: "M4 19.5A2.5 2.5 0 0 1 6.5 17H20M4 19.5A2.5 2.5 0 0 0 6.5 22H20V2H6.5A2.5 2.5 0 0 0 4 4.5z" },
  { href: "/dashboard/masalar", key: "navTables", icon: "M3 3h6v6H3zM15 3h6v6h-6zM3 15h6v6H3zM15 15h3v3h-3zM18 18h3v3h-3z" },
  { href: "/dashboard/siparisler", key: "navOrders", icon: "M9 2h6l1 3h3v15a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5h3zM9 11h6M9 15h6" },
    ...
    <aside className="flex h-full w-full flex-col bg-[#1c1712] text-white md:w-64">
      <div className="flex items-center gap-2 px-5 py-5">
        ...
        <div className="min-w-0 leading-tight">
          ...
          <div className="text-[11px] text-white/50">{t("adminPanel")}</div>
        </div>
      </div>
